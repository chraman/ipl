...
(function($, my) {
  ...
  my.getDataset = function(data, options, error, success) {
    var dataset = my.createDataset(data, options.fields, options.metadata);
    success(dataset);
  };
  ...
  my.BackboneSyncer = function(data) {
