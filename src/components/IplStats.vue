...
<template>
  ...
  <div>
    <ul class="nav nav-pills">
      <li role="presentation" class="active"><a href="#iplStats">Home</a></li>
      <li role="presentation"><a href="#bowlersStats">Profile</a></li>
      <li role="presentation"><a href="#batsman">Messages</a></li>
  </ul>
  </div>
  <div class="row">
